...
<div class="relative w-full" x-data="{ currentSlide: 0 }" x-init="if ({{ $totalSlides }} > 1) { setInterval(() => { currentSlide = (currentSlide + 1) % {{ $totalSlides }} }, 5000) }">
    <div class="relative h-[220px] sm:h-[320px] md:h-[400px] lg:h-[520px] 2xl:h-[600px] overflow-hidden w-full">
...
@else
    ...
    <div class="relative h-[220px] sm:h-[320px] md:h-[400px] lg:h-[520px] 2xl:h-[600px] flex items-center justify-center bg-gray-100">
