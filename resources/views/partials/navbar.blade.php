...
<div x-data="{ mobileMenuOpen: false, openExtMobile: false, openMobile: false, openInfraMobile: false }">
  <div class="w-full bg-gray-800" style="background: #1a1a1a !important; color: #fff !important;">
    ...
    <a href="/" class="flex items-center space-x-2 sm:space-x-3 flex-1 min-w-0">
      ...
      <div class="min-w-0">
        <span class="block lg:hidden text-xs font-normal text-[#2979FF] truncate">INSTITUTO SUPERIOR POLITÉCNICO DO BIÉ</span>
      </div>
    </a>
    ...
    <nav role="navigation" aria-label="Navegação principal" class="hidden lg:flex flex-row items-center space-x-4 xl:space-x-6 mb-0 pb-0 border-b-0">
      <a href="/cursos" class="flex items-center space-x-1 text-[#2979FF] font-normal uppercase text-sm tracking-wide hover:text-[#FFD700] transition-colors whitespace-nowrap focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#F05A28]" aria-label="Cursos">
      ...
      <a href="/investigacao" class="flex items-center space-x-1 text-[#2979FF] font-normal uppercase text-sm tracking-wide hover:text-[#FFD700] transition-colors whitespace-nowrap focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#F05A28]" aria-label="Pesquisa e Inovação">
      ...
      <div x-data="{ open: false }" class="relative inline-block">
        <button @click="open = !open" @keydown.escape="open = false"
          class="flex items-center gap-1 text-[#2979FF] hover:text-[#FFD700] font-normal uppercase text-sm tracking-wide focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#F05A28]"
      ...
      <div x-data="{ openExt: false }" class="relative inline-block">
        <button @click="openExt = !openExt" @keydown.escape="openExt = false"
          class="flex items-center gap-1 text-[#2979FF] hover:text-[#FFD700] font-normal uppercase text-sm tracking-wide"
  ...
  <div id="mobile-menu" role="dialog" aria-modal="false" aria-label="Menu principal" x-show="mobileMenuOpen" x-cloak class="fixed inset-0 z-50 flex lg:hidden overflow-x-hidden w-full max-w-full">
    ...
    <div class="relative ml-auto w-full max-w-xs h-full bg-white/70 shadow-2xl flex flex-col py-10 px-6 space-y-3 overflow-y-auto animate-slide-in-right border-l-4 border-[#FFD700] rounded-l-2xl text-base sm:text-sm z-[60]" style="backdrop-filter: blur(12px);">
      ...
      <a href="/cursos" class="flex items-center space-x-3 py-2 px-4 text-[#2979FF] font-normal text-base hover:text-[#2563eb] hover:bg-gray-50 rounded transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#F05A28]" aria-label="Ensino">
      ...
      <a href="/investigacao" class="flex items-center space-x-3 py-2 px-4 text-[#2979FF] font-normal text-base hover:text-[#2563eb] hover:bg-gray-50 rounded transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#F05A28]" aria-label="Pesquisa e Inovação">
      ...
      <a href="/noticias" class="flex items-center space-x-3 py-2 px-4 text-[#2979FF] font-normal text-base hover:text-[#2563eb] hover:bg-gray-50 rounded transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#F05A28]" aria-label="Notícias">
      ...
      <a href="/candidaturas" class="flex items-center space-x-3 py-2 px-4 text-[#2979FF] font-normal text-base hover:text-[#2563eb] hover:bg-gray-50 rounded transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#F05A28]" aria-label="Candidaturas">
        <span>
      ...
      <div class="relative lg:hidden">
        <button @click="openExtMobile = !openExtMobile"
          class="flex items-center space-x-3 py-2 px-4 text-[#2979FF] font-normal hover:text-[#2563eb] hover:bg-gray-50 rounded transition-colors w-full">
      ...
      <div class="border-t border-gray-200 pt-4 mt-4">
        ...
        <a href="/contactos" class="flex items-center space-x-3 py-2 px-4 text-[#2979FF] hover:text-[#2563eb] hover:bg-gray-50 rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#F05A28]" aria-label="Contacto">
        ...
        <a href="http://www.isp-bie.ao/webmail" target="_blank" rel="noopener noreferrer" aria-label="Abrir Webmail (abre em nova aba)" class="flex items-center space-x-3 py-2 px-4 text-[#2979FF] hover:text-[#2563eb] hover:bg-gray-50 rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#F05A28]">
        ...
        <a href="/servicos" class="flex items-center space-x-3 py-2 px-4 text-[#2979FF] hover:text-[#2563eb] hover:bg-gray-50 rounded">
        ...
        <a href="/presidencia" class="flex items-center space-x-3 py-2 px-4 text-[#2979FF] hover:text-[#2563eb] hover:bg-gray-50 rounded">
        ...
        <div class="relative lg:hidden mt-2">
            <button @click="openMobile = !openMobile"
              class="flex items-center gap-3 py-2 px-4 text-[#2979FF] hover:text-[#2563eb] hover:bg-gray-50 rounded w-full font-normal">
      ...
      <div class="border-t border-gray-200 pt-4 mt-4">
        ...
        <a href="/calendario-academico" class="flex items-center space-x-3 py-2 px-4 text-[#2979FF] hover:text-[#2563eb] hover:bg-gray-50 rounded">
          <span><svg class="w-5 h-5" fill="none" stroke="#2563eb" stroke-width="2" viewBox="0 0 24 24"><rect x="3" y="5" width="18" height="14" rx="2" stroke="#2563eb"/><path d="M7 9h10M7 13h6" stroke="#2563eb"/></svg></span>
          <span>Calendário Académico</span>
        </a>
        <a href="/guia-estudante" class="flex items-center space-x-3 py-2 px-4 text-[#2979FF] hover:text-[#2563eb] hover:bg-gray-50 rounded">
        ...
        <a href="/resultados" class="flex items-center space-x-3 py-2 px-4 text-[#2979FF] hover:text-[#2563eb] hover:bg-gray-50 rounded">
          <span><svg class="w-5 h-5" fill="none" stroke="#2563eb" stroke-width="2" viewBox="0 0 24 24"><rect x="5" y="7" width="14" height="10" rx="2" stroke="#2563eb"/><path d="M8 11h8" stroke="#2563eb"/></svg></span>
