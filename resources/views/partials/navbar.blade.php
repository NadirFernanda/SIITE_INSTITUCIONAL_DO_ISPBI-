...
<div x-data="{ mobileMenuOpen: false, openExtMobile: false, openMobile: false, openInfraMobile: false }">
  <div class="w-full bg-[#1a1a1a]" style="background: rgba(26,26,26,0.9) !important; color: #fff !important;">
      ...
      <div class="border-t border-gray-200 pt-4 mt-4">
        ...
        <div class="relative lg:hidden mt-2">
            <button @click="openMobile = !openMobile"
              class="flex items-center gap-3 py-2 px-4 text-[#2979FF] hover:text-[#2563eb] hover:bg-gray-50 rounded w-full font-semibold">
