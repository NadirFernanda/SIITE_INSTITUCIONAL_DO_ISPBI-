    ...
    <nav class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 md:gap-8" aria-label="Links institucionais">
      ...
      <div>
        ...
        <ul class="space-y-2 text-sm" aria-labelledby="footer-ensino">
          ...
          <li><a href="https://www.ujes.ao" target="_blank" rel="noopener" class="hover:text-[#3B82F6] transition-colors">Universidade José Eduardo dos Santos</a></li>
          <li><a href="https://ukb.ed.ao" target="_blank" rel="noopener" class="hover:text-[#3B82F6] transition-colors">Universidade Katyavala Bwila</a></li>
          <li><a href="https://www.ulan.ao" target="_blank" rel="noopener" class="hover:text-[#3B82F6] transition-colors">Universidade Lueji A'Nkonde</a></li>
          <li><a href="https://www.umn.ao" target="_blank" rel="noopener" class="hover:text-[#3B82F6] transition-colors">Universidade Mandume Ya Ndemufayo</a></li>
