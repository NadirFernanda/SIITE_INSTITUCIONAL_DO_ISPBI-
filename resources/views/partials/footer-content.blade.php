      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
        ...
        <div>
          ...
          <div class="flex gap-3 mt-4">
            ...
            <a href="https://instagram.com" target="_blank" class="text-gray-400 hover:text-[#3B82F6] transition-colors">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          <div>
            ...
            <div class="grid grid-cols-2 gap-2 sm:flex sm:flex-wrap sm:gap-3">
              ...
              <a href="https://instagram.com/ispbie" target="_blank" 
              ...
              <a href="https://linkedin.com/school/ispbie" target="_blank" 
              ...
              <a href="https://youtube.com/@ispbie" target="_blank" 
