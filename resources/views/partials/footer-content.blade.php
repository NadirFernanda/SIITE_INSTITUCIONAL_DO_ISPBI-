    ...
    <nav class="grid grid-cols-2 gap-6 md:grid-cols-3 lg:grid-cols-6 md:gap-8" aria-label="Links institucionais">
      ...
      <h2 class="text-[#2979FF] font-bold text-lg mb-4 flex items-center gap-2" id="footer-fale">
        ...
        <div class="mt-2 flex items-center gap-2">
          <a href="https://wa.me/244000000000" target="_blank" rel="noopener" class="bg-[#25D366] hover:bg-[#1a1a1a] text-white font-bold px-4 py-2 rounded-full flex items-center gap-2 shadow transition-colors duration-300" aria-label="WhatsApp institucional">
