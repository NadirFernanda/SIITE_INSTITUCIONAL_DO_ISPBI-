...
<head>
    ...
    <style>
        ...
        .sidebar {
            width:220px; background:#0e5c2f; color:#fff; height:100vh;
        ...
        .sidebar-logo span { display:block; font-size:0.78rem; font-weight:400; color:#86efac; margin-top:2px; }
        .sidebar a {
        ...
        .sidebar a:hover, .sidebar a.active { background:#166534; }
        .sidebar .badge {
        ...
        .header {
            background:#0e5c2f; padding:18px 36px; margin-left:220px;
    ...
    <div class="sidebar">
        ...
        <div style="margin:16px 12px;">
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit"
                        style="width:100%;background:#fff;color:#0e5c2f;font-weight:700;padding:9px 0;border:none;border-radius:8px;cursor:pointer;">
                    Sair
                </button>
            </form>
        </div>
