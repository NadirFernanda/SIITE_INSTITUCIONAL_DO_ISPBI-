...
<div style="max-width:1000px;margin:0 auto;">
    ...
    <div style="display:flex;align-items:flex-start;justify-content:space-between;flex-wrap:wrap;gap:12px;margin-bottom:22px;">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap;">
            <a href="{{ route('daac.salas.pdf', $sala) }}"
            ...
            <a href="{{ route('daac.salas.excel-exame', $sala) }}"
            ...
            <a href="{{ route('daac.salas.excel-notas', $sala) }}"
            ...
            <table style="width:100%;border-collapse:collapse;font-size:0.87rem;">
                <thead>
                    <tr style="border-bottom:1px solid #e2e8f0;background:#f8fafc;">
                        ...
                        <th style="padding:10px 18px;text-align:left;font-weight:700;color:#475569;">BI</th>
