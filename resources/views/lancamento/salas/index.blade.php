...
<div style="padding:32px 24px;max-width:1100px;margin:0 auto;">
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;margin-bottom:26px;">
        <div>
            ...
            <p style="color:#64748b;font-size:0.92rem;margin:0;">Gestão das salas e distribuição de candidatos para lançamento de notas.</p>
        </div>
        <div style="display:flex;gap:10px;flex-wrap:wrap;">
            <form method="POST" action="{{ route('lancamento.salas.distribuir') }}"
            ...
            <form method="POST" action="{{ route('lancamento.salas.limpar') }}"
    ...
    <div style="background:linear-gradient(135deg, #eaeff5 0%, #dbe3ee 100%);border:1.5pt solid #a8c4e0;border-radius:14px;padding:16px 20px;margin-bottom:22px;">
        ...
        <form method="GET" style="display:flex;flex-wrap:wrap;gap:10px;align-items:flex-end;">
            ...
            <button type="submit" formaction="{{ route('lancamento.salas.pdf-lote') }}"
            ...
            <button type="submit" formaction="{{ route('lancamento.salas.pdf-exame-lote') }}"
                    style="background:#1e3a5f;color:#fff;border:none;border-radius:8px;padding:9px 16px;font-weight:700;cursor:pointer;font-size:0.85rem;white-space:nowrap;">
                📄 PDF Exame
            </button>
            <button type="submit" formaction="{{ route('lancamento.salas.excel-exame-lote') }}"
    ...
    <div style="background:linear-gradient(135deg, #eaeff5 0%, #dbe3ee 100%);border:1.5pt solid #a8c4e0;border-radius:14px;padding:16px 20px;margin-bottom:22px;">
        ...
        <form method="GET" style="display:flex;flex-wrap:wrap;gap:10px;align-items:flex-end;">
            ...
            <button type="submit" formaction="{{ route('lancamento.salas.pdf-exame-lote-curso') }}"
                    style="background:#1e3a5f;color:#fff;border:none;border-radius:8px;padding:9px 16px;font-weight:700;cursor:pointer;font-size:0.85rem;white-space:nowrap;">
                📄 PDF Exame
            </button>
            <button type="submit" formaction="{{ route('lancamento.salas.excel-exame-lote-curso') }}"
                    style="background:#15803d;color:#fff;border:none;border-radius:8px;padding:9px 16px;font-weight:700;cursor:pointer;font-size:0.85rem;white-space:nowrap;">
                📊 Excel Exame
            </button>
        </form>
                ...
                <tr style="border-bottom:1px solid #f1f5f9;">
                    ...
                    <td style="padding:12px 16px;">
                        <div style="display:flex;gap:5px;flex-wrap:wrap;align-items:center;">
                            <a href="{{ route('lancamento.salas.show', $sala) }}" title="Ver detalhe"
                            ...
                            <a href="{{ route('lancamento.salas.pdf', $sala) }}" title="Lista geral PDF"
                            ...
                            <a href="{{ route('lancamento.salas.excel-exame', $sala) }}" title="Lista de exame Excel"
