{{--
    Conteúdo de uma sala para a Lista de Exame (só N.º Ficha) — ver
    pdf/_sala-conteudo.blade.php para a explicação da paginação manual e do
    porquê deste partial existir isolado (permite concatenar várias salas
    num único documento na impressão em lote sem duplicar <html>/<body>).
