...
<div style="padding:32px 24px;max-width:860px;margin:0 auto;">
    ...
    <div style="display:flex;align-items:flex-start;justify-content:space-between;flex-wrap:wrap;gap:12px;margin-bottom:28px;">
        ...
        <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;">
            ...
            @else
            <span style="display:inline-flex;align-items:center;gap:6px;background:#e2e8f0;color:#64748b;border-radius:8px;padding:8px 16px;font-weight:700;font-size:0.88rem;cursor:not-allowed;"
