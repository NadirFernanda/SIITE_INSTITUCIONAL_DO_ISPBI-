...
<div style="max-width:620px;margin:0 auto;padding:36px 24px 48px;">
    ...
    <div style="display:flex;align-items:center;gap:16px;margin-bottom:32px;">
        ...
        <div>
            <h1 style="font-size:1.6rem;font-weight:800;color:#1a202c;margin:0 0 3px;">Editar Estatística</h1>
            <p style="color:#64748b;font-size:0.9rem;margin:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:440px;">{{ $estatistica->titulo }}</p>
        </div>
    </div>
