...
<div style="max-width:1100px;margin:0 auto;">
    ...
    <form method="POST" action="{{ route('admin.resultados.vagas') }}">
        @csrf
            ...
            <tbody>
                ...
                <tr style="border-top:1px solid #e2e8f0;">
                    ...
                    <td style="padding:10px 14px;text-align:center;white-space:nowrap;">
                        <a href="{{ route('admin.resultados.show', ['curso' => $linha['curso'], 'periodo' => $linha['periodo']]) }}" style="color:#1565c0;font-weight:600;text-decoration:none;">Ver / Calcular</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
