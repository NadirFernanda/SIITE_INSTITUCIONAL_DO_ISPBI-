...
<div style="max-width:680px;margin:0 auto;padding:36px 24px 48px;">
    ...
    <div style="display:flex;align-items:center;gap:16px;margin-bottom:32px;">
        ...
        <div>
            <h1 style="font-size:1.6rem;font-weight:800;color:#1a202c;margin:0 0 3px;">Novo Concurso</h1>
            <p style="color:#64748b;font-size:0.9rem;margin:0;">Preencha os dados do novo processo seletivo.</p>
        </div>
    </div>
    ...
    <form id="concurso-form" action="{{ route('admin.concursos.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div style="padding:22px;display:flex;flex-direction:column;gap:16px;">
                ...
                <div>
                    ...
                    <select name="area"
                        ...
                        <option value="Técnico Especializado" {{ old('area')==='Técnico Especializado'?'selected':'' }}>Técnico Especializado</option>
                        <option value="Investigação Científica" {{ old('area')==='Investigação Científica'?'selected':'' }}>Investigação Científica</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div style="background:#fff;border-radius:14px;border:1px solid #e2e8f0;box-shadow:0 1px 6px rgba(0,0,0,0.06);margin-bottom:28px;overflow:hidden;">
            <div style="padding:14px 22px;border-bottom:1px solid #f1f5f9;background:#f8fafc;">
                <span style="font-size:0.8rem;font-weight:700;color:#64748b;letter-spacing:0.06em;text-transform:uppercase;">Anexos</span>
            </div>
