        ...
        <div style="display:flex;align-items:center;gap:10px;">
            <div style="position:relative;flex:1;max-width:400px;">
                ...
                <input type="text" name="q" value="{{ request('q') }}" placeholder="Buscar por nome ou email"
                       style="width:100%;box-sizing:border-box;border:1px solid #d1d5db;border-radius:8px;padding:10px 14px 10px 38px;font-size:0.9rem;color:#1a202c;outline:none;"
                       onfocus="this.style.borderColor='#1565c0';this.style.boxShadow='0 0 0 3px rgba(21,101,192,0.1)'"
                       onblur="this.style.borderColor='#d1d5db';this.style.boxShadow='none'">
            </div>
            <button type="submit"
                    style="padding:10px 20px;border-radius:8px;background:#1565c0;color:#fff;font-weight:600;font-size:0.9rem;border:none;cursor:pointer;"
                    onmouseover="this.style.background='#0d47a1'" onmouseout="this.style.background='#1565c0'">Buscar</button>
        </div>
    </form>
