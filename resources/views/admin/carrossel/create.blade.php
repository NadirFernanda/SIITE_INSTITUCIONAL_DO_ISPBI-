...
<div style="max-width:620px;margin:0 auto;padding:36px 24px 48px;">
    ...
    <div style="display:flex;align-items:center;gap:16px;margin-bottom:32px;">
        ...
        <div>
            <h1 style="font-size:1.6rem;font-weight:800;color:#1a202c;margin:0 0 3px;">Novo Slide</h1>
            <p style="color:#64748b;font-size:0.9rem;margin:0;">Adicione um novo slide ao carrossel da página inicial.</p>
        </div>
    </div>
        ...
        <div style="background:#fff;border-radius:14px;border:1px solid #e2e8f0;box-shadow:0 1px 6px rgba(0,0,0,0.06);margin-bottom:20px;overflow:hidden;">
            ...
            <div style="padding:22px;display:flex;flex-direction:column;gap:16px;">
                <div>
                    ...
                    <input type="text" name="titulo" value="{{ old('titulo') }}" required placeholder="Ex: Bem-vindo ao ISP-Bié"
                ...
                <div>
                    ...
                    <input type="text" name="subtitulo" value="{{ old('subtitulo') }}" placeholder="Breve descrição exibida no slide"
                           style="width:100%;box-sizing:border-box;border:1px solid #d1d5db;border-radius:8px;padding:10px 14px;font-size:0.95rem;color:#1a202c;outline:none;"
                           onfocus="this.style.borderColor='#1565c0';this.style.boxShadow='0 0 0 3px rgba(21,101,192,0.1)'"
                           onblur="this.style.borderColor='#d1d5db';this.style.boxShadow='none'">
                </div>
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                    <div>
                        ...
                        <input type="text" name="texto_botao" value="{{ old('texto_botao') }}" placeholder="Ex: Saiba mais"
                               style="width:100%;box-sizing:border-box;border:1px solid #d1d5db;border-radius:8px;padding:10px 14px;font-size:0.95rem;color:#1a202c;outline:none;"
                               onfocus="this.style.borderColor='#1565c0';this.style.boxShadow='0 0 0 3px rgba(21,101,192,0.1)'"
                               onblur="this.style.borderColor='#d1d5db';this.style.boxShadow='none'">
                    </div>
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;align-items:end;">
                    ...
                    <div>
                        <label style="display:flex;align-items:center;gap:10px;cursor:pointer;padding:10px 14px;border:1px solid #d1d5db;border-radius:8px;background:#f8fafc;">
                            <input type="checkbox" name="publicado" value="1" {{ old('publicado') ? 'checked' : '' }}
                                   style="width:16px;height:16px;accent-color:#1565c0;cursor:pointer;">
        ...
        <div style="background:#fff;border-radius:14px;border:1px solid #e2e8f0;box-shadow:0 1px 6px rgba(0,0,0,0.06);margin-bottom:28px;overflow:hidden;">
            ...
            <div style="padding:22px;">
                <label style="display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px;border:2px dashed #cbd5e1;border-radius:10px;padding:28px;cursor:pointer;background:#f8fafc;"
                    ...
                    <span id="img-label" style="font-size:0.9rem;color:#64748b;font-weight:500;">Clique para selecionar imagem</span>
                    <span style="font-size:0.75rem;color:#94a3b8;">JPG, PNG, WEBP recomendados</span>
                    <input type="file" name="imagem" accept="image/*" style="display:none;"
                           onchange="document.getElementById('img-label').textContent = this.files[0] ? this.files[0].name : 'Clique para selecionar imagem'">
                </label>
            </div>
        </div>
