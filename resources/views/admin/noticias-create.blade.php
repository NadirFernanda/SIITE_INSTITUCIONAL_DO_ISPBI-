    ...
    <form method="POST" action="{{ route('admin.noticias.store') }}" enctype="multipart/form-data">
            ...
            <div style="padding:22px;display:flex;flex-direction:column;gap:18px;">
                ...
                <div>
                    ...
                    <label for="imagem"
                        ...
                        <input type="file" name="imagem" id="imagem" accept="image/*" style="display:none;"
                               onchange="document.getElementById('imagem-label').innerHTML = this.files[0] ? '<strong style=\'color:#1e3a5f\'>' + this.files[0].name + '</strong>' : 'Clique para selecionar imagem'">
                    </label>
                </div>
                ...
                <div>
                    ...
                    <label for="documentos"
                        ...
                        <span id="docs-label" style="font-size:0.82rem;color:#64748b;text-align:center;">Clique para selecionar documentos<br><span style="color:#94a3b8;font-size:0.78rem;">PDF, DOC, DOCX — máx. 25 MB cada — pode selecionar vários</span></span>
        ...
        function updateDocsLabel(input) {
            ...
            if (input.files.length > 0) {
                ...
                label.innerHTML = 'Clique para selecionar documentos<br><span style="color:#94a3b8;font-size:0.78rem;">PDF, DOC, DOCX — máx. 25 MB cada — pode selecionar vários</span>';
            }
        }
        </script>
