    ...
    <div x-data="{ dark: false }" :class="dark ? 'bg-[#1a237e]' : 'bg-[#2563eb]'" class="py-4 transition-colors duration-500 relative">
      ...
      <div class="w-full 2xl:max-w-screen-2xl mx-auto px-2 sm:px-6 lg:px-12 flex flex-col md:flex-row items-center justify-between gap-8 mt-6">
        <div class="flex flex-wrap items-center justify-center gap-6 md:gap-8 text-white w-full md:w-auto">
          ...
          <a href="https://www.facebook.com/search/top?q=instituto%20superior%20polit%C3%A9cnico%20do%20bi%C3%A9" target="_blank" rel="noopener" class="rounded-full bg-white shadow-xl hover:bg-[#2563eb] hover:text-white transition-all transform hover:scale-110 flex items-center justify-center w-14 h-14 md:w-16 md:h-16 border-2 border-white" aria-label="Facebook">
          ...
          <a href="https://www.linkedin.com/company/instituto-superior-polit%C3%A9cnico-do-bi%C3%A9" target="_blank" rel="noopener" class="rounded-full bg-white shadow-xl hover:bg-[#2563eb] hover:text-white transition-all transform hover:scale-110 flex items-center justify-center w-14 h-14 md:w-16 md:h-16 border-2 border-white" aria-label="LinkedIn">
          ...
          <a href="https://www.instagram.com/ispbie?igsh=MWpuaWVwMnYyN3c3OA==" target="_blank" rel="noopener" class="rounded-full bg-white shadow-xl hover:bg-[#2563eb] hover:text-white transition-all transform hover:scale-110 flex items-center justify-center w-14 h-14 md:w-16 md:h-16 border-2 border-white" aria-label="Instagram">
          ...
          <a href="https://youtube.com/@ispbieoficial?si=s1somPSkOYJ2PxQC" target="_blank" rel="noopener" class="rounded-full bg-white shadow-xl hover:bg-[#2563eb] hover:text-white transition-all transform hover:scale-110 flex items-center justify-center w-14 h-14 md:w-16 md:h-16 border-2 border-white" aria-label="YouTube">
