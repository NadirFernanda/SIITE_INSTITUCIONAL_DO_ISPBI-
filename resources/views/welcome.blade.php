    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3 md:gap-4">
        ...
        <a href="/resultados" aria-label="Portal ISP-Bié"
           class="flex flex-col items-center gap-2 p-3 sm:p-5 bg-white rounded-xl border border-gray-100 shadow-sm text-center focus:outline-none focus:ring-2 focus:ring-[#F05A28] focus:ring-offset-2"
