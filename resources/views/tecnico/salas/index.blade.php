        ...
        <div style="background:#fff;border:1px solid #e2e8f0;border-radius:14px;padding:24px;">
            ...
            <form method="POST" action="{{ route('tecnico.salas.store') }}">
                ...
                <div style="margin-bottom:14px;">
                    ...
                    @error('nome')<p style="color:#ef4444;font-size:0.78rem;margin:4px 0 0;">{{ $message }}</p>@enderror
                </div>
                <div style="margin-bottom:16px;">
                    ...
                    @error('capacidade')<p style="color:#ef4444;font-size:0.78rem;margin:4px 0 0;">{{ $message }}</p>@enderror
                </div>
                <button type="submit"
                ...
                <tr style="border-bottom:1px solid #f1f5f9;">
                    ...
                    <td style="padding:14px 20px;text-align:center;">
                        <div style="display:flex;gap:6px;justify-content:center;flex-wrap:wrap;">
                            <a href="{{ route('tecnico.salas.show', $sala) }}"
                        ...
                        <div id="edit-{{ $sala->id }}" style="display:none;margin-top:8px;background:#fefce8;border:1px solid #fde68a;border-radius:8px;padding:10px;">
                            <form method="POST" action="{{ route('tecnico.salas.update', $sala) }}" style="display:flex;gap:8px;align-items:center;flex-wrap:wrap;">
                                @csrf @method('PATCH')
