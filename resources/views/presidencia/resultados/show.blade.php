...
<div style="max-width:1100px;margin:0 auto;">
    <a href="{{ route('presidencia.resultados.index') }}" style="color:#1565c0;text-decoration:none;font-weight:600;">&larr; Voltar</a>
    ...
    <form method="POST" action="{{ route('presidencia.resultados.calcular') }}" style="margin-bottom:24px;" onsubmit="return confirm('Recalcular os resultados deste curso/período? Isto substitui o resultado actual de todos os candidatos.');">
        @csrf
