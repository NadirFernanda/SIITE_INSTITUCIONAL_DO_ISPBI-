...
@section('title', 'Busca na Biblioteca - ISP-Bi�')
...
@section('content')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 mb-6 scroll-reveal">
        <div class="bg-white rounded-lg shadow-md p-8 interactive-card">
            ...
            <p class="text-gray-600">Pesquise no cat�logo da biblioteca.</p>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 scroll-reveal">
        <div class="max-w-4xl mx-auto mb-16">
            <div class="bg-white p-8 rounded-lg shadow-md interactive-card">
                <div class="mb-6">
                    <div class="relative">
                        <input type="text" placeholder="T�tulo, autor, ISBN, palavra-chave..." class="w-full px-6 py-4 pr-12 text-lg border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <select class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                            ...
                            <option>Peri�dicos</option>
                            <option>Artigos</option>
                            <option>Teses</option>
                            <option>Multim�dia</option>
                        </select>
                    </div>

                    <div>
                        <label class="block text-gray-700 font-semibold mb-2">�rea do Conhecimento</label>
                        <select class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <option>Todas</option>
        ...
        <section class="mb-16 scroll-reveal">
            <h2 class="text-3xl font-bold text-gray-900 mb-8">Acesso R�pido</h2>
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <a href="#" class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow text-center interactive-card">
                    ...
                    <h3 class="font-semibold text-gray-900">Peri�dicos</h3>
                </a>
            </div>
        </section>

        <div class="bg-gradient-to-r from-[#2563eb] to-[#2563eb] rounded-xl p-8 text-white text-center scroll-reveal">
            <h2 class="text-3xl font-bold mb-4">N�o encontrou o que procura?</h2>
            <p class="text-xl mb-8">Solicite ao bibliotec�rio</p>
