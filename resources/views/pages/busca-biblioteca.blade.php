...
<head>
    ...
    <title>Busca na Biblioteca - Instituto Superior Politécnico do Bié</title>
...
<body class="bg-gray-50">
    ...
    <div class="bg-gradient-to-r from-[#2563eb] to-[#2563eb] text-white py-16">
        <div class="container mx-auto px-6">
            <h1 class="text-5xl font-bold mb-4">Busca na Biblioteca</h1>
            <p class="text-xl text-blue-100">Pesquise no catálogo da biblioteca</p>
        </div>
    </div>
    ...
    <div class="container mx-auto px-6 py-12">
        ...
        <section class="mb-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                <a href="#" class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow text-center">
