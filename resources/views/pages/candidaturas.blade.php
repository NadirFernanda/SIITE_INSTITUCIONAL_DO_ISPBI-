        ...
        <section class="mb-16 scroll-reveal">
            <div class="bg-orange-50 border-l-4 border-orange-600 p-6 mb-8">
                <div class="flex items-center">
                    ...
                    <div>
                        <h3 class="font-bold text-orange-900">Candidaturas para o ano acadêmico 2024/2025</h3>
                        <p class="text-orange-800">As candidaturas para o ano de 2025/2026 estão encerradas</p>
                    </div>
                </div>
            </div>
        ...
        <section class="mb-16 scroll-reveal">
            ...
            <div class="flex flex-wrap justify-center gap-8">
                <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow interactive-card w-full max-w-md">
                    ...
                    <a href="/cursos" class="text-teal-600 hover:text-teal-700 font-medium">Ver todos os cursos →</a>
                </div>
            </div>
        </section>
