                                ...
                                <div id="formulario-candidatura" class="bg-white border border-[#2563eb]/20 rounded-2xl shadow-lg p-4 sm:p-8">
                                    ...
                                    <div class="flex flex-col items-center justify-center text-center py-12 px-4">
                                        <div class="w-20 h-20 bg-amber-50 rounded-full flex items-center justify-center mb-6">
                                            <svg class="w-10 h-10 text-amber-500" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6l4 2m6-2a10 10 0 11-20 0 10 10 0 0120 0z"/></svg>
                                        </div>
                                        <h2 class="text-2xl sm:text-3xl font-bold text-gray-800 mb-3">Candidaturas em Breve</h2>
                                        <p class="text-lg text-gray-600 mb-2 max-w-xl">
                                            As candidaturas para o ano lectivo <strong>2026/2027</strong> serão abertas em <strong class="text-[#2563eb]">Agosto</strong>.
                                        </p>
                                        <p class="text-gray-500 mb-8 max-w-lg">
                                            Fique atento às nossas páginas nas redes sociais para ser o primeiro a saber quando as candidaturas abrirem.
                                        </p>
                                        <div class="flex flex-wrap justify-center gap-3">
                                            <a href="https://www.facebook.com/search/top?q=instituto%20superior%20polit%C3%A9cnico%20do%20bi%C3%A9" target="_blank"
                                               class="inline-flex items-center gap-2 bg-[#1877F2] text-white px-5 py-2.5 rounded-lg font-semibold text-sm hover:bg-[#166fe5] transition">
                                            ...
                                            <a href="https://www.instagram.com/ispbie?igsh=MWpuaWVwMnYyN3c3OA==" target="_blank"
                                               class="inline-flex items-center gap-2 bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045] text-white px-5 py-2.5 rounded-lg font-semibold text-sm hover:opacity-90 transition">
                                    ...
                                    @if(false){{-- Remover @if(false) e @endif abaixo quando as candidaturas abrirem --}}
