...
@section('hero')
    @include('partials.hero', [
        'title' => 'Guia do Estudante 2025/2026',
        'subtitle' => 'Manual Completo para Estudantes do ISP-Bié'
    ])
@endsection
  ...
  <section class="py-8 bg-white border-b">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex flex-col md:flex-row items-center justify-between">
        ...
        <a href="#" class="mt-4 md:mt-0 inline-flex items-center bg-[#2563eb] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#1f3342] transition-colors">
      ...
      <div id="servicos" class="bg-white rounded-lg shadow-md p-8 mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="border-l-4 border-[#3B82F6] pl-4">
            ...
            <p class="text-gray-600 mb-2">Declarações, certidões e históricos escolares.</p>
            <p class="text-sm text-gray-500">Prazo: 5 a 10 dias úteis</p>
          </div>
          <div class="border-l-4 border-[#3B82F6] pl-4">
