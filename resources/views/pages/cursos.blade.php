      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow-md p-8 mb-12 interactive-card">
          ...
          <div class="space-y-8 max-w-5xl mx-auto">
            ...
            <div id="contabilidade" class="rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow interactive-card">
            ...
            <div id="informatica" class="rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow interactive-card">
              <div class="bg-gradient-to-r from-blue-700 to-blue-500 p-6" style="background: linear-gradient(to right, #1d4ed8, #3b82f6) !important;">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                  <div class="flex items-center space-x-4">
                    <div class="bg-white p-3 rounded-full">
            ...
            <!-- ...outros cards devem ser ajustados da mesma forma, dentro do mesmo container pai... -->
          </div>
