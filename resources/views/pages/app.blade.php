...
@section('title', 'App ISP-Bi�')

@section('content')

    <div class="bg-gradient-to-r from-[#2563eb] to-[#3B82F6] text-white py-16 scroll-reveal">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 class="text-5xl font-bold mb-4">App ISP-Bi�</h1>
            <p class="text-xl text-purple-100">Aplicativo m�vel oficial</p>
        </div>
    </div>
    ...
    <div class="bg-white border-b">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
            <div class="flex items-center text-sm text-gray-600">
                ...
                <span class="text-gray-900">App ISP-Bi�</span>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 scroll-reveal">
        <div class="text-center mb-16">
            ...
            <p class="text-gray-600 mb-8">Acesse todos os servi�os do ISP-Bi� na palma da sua m�o</p>
            <div class="flex justify-center gap-4">
                ...
                <button class="bg-black text-white px-6 py-3 rounded-lg flex items-center hover:bg-gray-800">
                    ...
                    <div class="text-left">
                        <div class="text-xs">Dispon�vel no</div>
        ...
        <section class="mb-16 scroll-reveal">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md text-center interactive-card">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-2">Hor�rios</h3>
                    <p class="text-gray-600">Consulte seus hor�rios de aulas</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md text-center interactive-card">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-2">Notifica��es</h3>
