          ...
          <div class="bg-white border-l-4 border-[#2563eb] p-8 shadow-lg rounded-lg">
            ...
            <div class="prose max-w-none text-gray-700 leading-relaxed space-y-4">
              ...
              <div class="grid md:grid-cols-2 gap-6 mt-8">
                <div class="bg-gradient-to-br from-[#2563eb]/10 to-[#3B82F6]/10 p-6 rounded-lg interactive-card">
                ...
                <div class="bg-gradient-to-br from-[#2563eb]/10 to-[#2563eb]/10 p-6 rounded-lg interactive-card">
                  <h3 class="font-bold text-lg text-[#2563eb] mb-3 flex items-center">
                    <svg class="w-6 h-6 mr-2 text-[#2563eb]" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="bg-gradient-to-br from-[#3B82F6]/10 to-[#2563eb]/10 p-6 rounded-lg interactive-card">
                  <h3 class="font-bold text-lg text-[#2563eb] mb-3 flex items-center">
                    <svg class="w-6 h-6 mr-2 text-[#2563eb]" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="bg-gradient-to-br from-[#3B82F6]/10 to-[#3B82F6]/10 p-6 rounded-lg interactive-card">
                  <h3 class="font-bold text-lg text-[#2563eb] mb-3 flex items-center">
                    <svg class="w-6 h-6 mr-2 text-[#2563eb]" fill="currentColor" viewBox="0 0 20 20">
