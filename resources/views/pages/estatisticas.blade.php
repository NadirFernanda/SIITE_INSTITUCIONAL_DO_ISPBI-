...
@section('title', 'Estat�sticas Institucionais - ISP-Bi�')
...
@section('content')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section class="mb-16 scroll-reveal">
            <h2 class="text-3xl font-bold text-gray-900 mb-8">Evolu��o de Matr�culas</h2>
        ...
        <section class="scroll-reveal">
            <h2 class="text-3xl font-bold text-gray-900 mb-8">Distribui��o por Curso</h2>
            <div class="bg-white p-8 rounded-lg shadow-md">
                <div class="space-y-4">
                    <div>
                        <div class="flex justify-between mb-2">
                            <span class="text-gray-700">Contabilidade e Administra��o</span>
                    ...
                    <div>
                        <div class="flex justify-between mb-2">
                            <span class="text-gray-700">Comunica��o Social</span>
