...
<body class="bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 mb-6 scroll-reveal">
        <div class="bg-white rounded-lg shadow-md p-8 text-center interactive-card">
    ...
    <div class="container mx-auto px-6 py-12 scroll-reveal">
        <div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md text-center interactive-card">
