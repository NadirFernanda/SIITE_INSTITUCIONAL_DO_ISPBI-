...
@section('hero')
    @include('partials.hero', [
        'title' => 'Cursos Online',
        'subtitle' => 'Educação à Distância - Em Desenvolvimento'
    ])
@endsection
  ...
  <section class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="max-w-4xl mx-auto">
        <div class="bg-gradient-to-r from-[#2563eb] to-[#3B82F6] rounded-2xl p-12 text-white text-center mb-12">
  ...
  <section class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-gradient-to-br from-[#3B82F6] to-[#2563eb] rounded-lg p-6 text-white">
        ...
        <div class="bg-gradient-to-br from-[#2563eb] to-[#2563eb] rounded-lg p-6 text-white">
          <svg class="w-12 h-12 mb-4" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="bg-gradient-to-br from-[#9C27B0] to-[#673AB7] rounded-lg p-6 text-white">
          <svg class="w-12 h-12 mb-4" fill="currentColor" viewBox="0 0 20 20">
        ...
        <!-- Contabilidade -->
        <div class="bg-gradient-to-br from-[#2563eb] to-[#3B82F6] rounded-lg p-6 text-white">
          <svg class="w-12 h-12 mb-4" fill="currentColor" viewBox="0 0 20 20">
