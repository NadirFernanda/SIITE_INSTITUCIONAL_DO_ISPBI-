...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 scroll-reveal">
        <nav class="text-sm opacity-75 mb-8">
            <a href="/" class="hover:underline">Início</a> \ Biblioteca Digital
        </nav>

        <div class="bg-white rounded-lg shadow-md p-8 mb-10 interactive-card">
            <h1 class="text-3xl md:text-4xl font-bold text-[#2563eb] mb-2">Biblioteca Digital</h1>
            <p class="text-lg text-gray-700">Acervo digital e recursos bibliográficos do ISP-Bié</p>
            <p class="mt-3 text-gray-600 max-w-2xl">Pesquise livros, artigos, periódicos e materiais multimídia disponíveis no acervo institucional.</p>
        </div>
