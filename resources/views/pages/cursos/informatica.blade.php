      ...
      <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
        ...
        <dl class="space-y-3 text-sm">
          <div class="flex items-center gap-2">
            <svg class="w-4 h-4 text-[#1D4ED8] flex-shrink-0" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path stroke-linecap="round" d="M12 6v6l4 2"/></svg>
            <div><dt class="text-gray-400 text-[11px]">Duração</dt><dd class="font-semibold text-[#1e3a5f]">5 Anos</dd></div>
          </div>
          <div class="flex items-center gap-2">
            <svg class="w-4 h-4 text-[#1D4ED8] flex-shrink-0" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
            <div><dt class="text-gray-400 text-[11px]">Vagas</dt><dd class="font-semibold text-[#1e3a5f]">40 por ano</dd></div>
          </div>
          <div class="flex items-center gap-2">
            <svg class="w-4 h-4 text-[#1D4ED8] flex-shrink-0" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><rect x="2" y="3" width="20" height="14" rx="2"/><path stroke-linecap="round" d="M8 21h8M12 17v4"/></svg>
            <div><dt class="text-gray-400 text-[11px]">Departamento</dt><dd class="font-semibold text-[#1e3a5f]">Engenharias</dd></div>
          </div>
          <div class="flex items-center gap-2">
            <svg class="w-4 h-4 text-[#1D4ED8] flex-shrink-0" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2"/><path stroke-linecap="round" d="M16 2v4M8 2v4M3 10h18"/></svg>
