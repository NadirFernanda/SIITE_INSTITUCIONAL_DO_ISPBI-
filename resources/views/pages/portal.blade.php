...
<body class="bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 mb-6 scroll-reveal">
        <div class="bg-white rounded-lg shadow-md p-8 flex items-start gap-4 interactive-card">
    ...
    <div class="container mx-auto px-6 py-12 scroll-reveal">
        ...
        <section class="mb-16 scroll-reveal">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                <a href="/biblioteca" class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow text-center group interactive-card">
                ...
                <a href="/repositorio" class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow text-center group interactive-card">
                    <div class="w-12 h-12 bg-orange-100 rounded-lg flex items-center justify-center mb-4 mx-auto group-hover:bg-orange-200 transition-colors">
                        <svg class="w-6 h-6 text-orange-600" fill="currentColor" viewBox="0 0 20 20">
                ...
                <a href="http://www.isp-bie.ao/webmail" target="_blank" rel="noopener" class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow text-center group interactive-card">
                    <div class="w-12 h-12 bg-orange-100 rounded-lg flex items-center justify-center mb-4 mx-auto group-hover:bg-orange-200 transition-colors">
                        <svg class="w-6 h-6 text-orange-600" fill="currentColor" viewBox="0 0 20 20">
                ...
                <a href="/revista" class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow text-center group interactive-card">
                    <div class="w-12 h-12 bg-orange-100 rounded-lg flex items-center justify-center mb-4 mx-auto group-hover:bg-orange-200 transition-colors">
                        <svg class="w-6 h-6 text-orange-600" fill="currentColor" viewBox="0 0 20 20">
        ...
        <!-- Links Rápidos -->
        <section class="bg-gradient-to-r from-[#2563eb] to-[#2563eb] rounded-xl p-8 text-white scroll-reveal interactive-card">
