				...
				<div class="space-y-4">
					...
					<div class="flex justify-between items-start">
						<div class="flex-1">
							...
							<span class="inline-block bg-[#2563eb] text-white text-sm px-3 py-1 rounded-full">Prazo: 7 dias úteis</span>
						</div>
					</div>
				</div>
				...
				<div class="bg-white p-6 rounded-lg shadow-md interactive-card">
					<div class="flex justify-between items-start">
						<div class="flex-1">
							...
							<span class="inline-block bg-[#2563eb] text-white text-sm px-3 py-1 rounded-full">Prazo: 15 dias úteis</span>
						</div>
					</div>
				</div>
				...
				<div class="bg-white p-6 rounded-lg shadow-md interactive-card">
					<div class="flex justify-between items-start">
						<div class="flex-1">
							...
							<span class="inline-block bg-[#2563eb] text-white text-sm px-3 py-1 rounded-full">Prazo: 5 dias úteis</span>
						</div>
					</div>
				</div>
			</div>
