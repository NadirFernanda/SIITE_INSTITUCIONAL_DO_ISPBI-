...
@section('title', 'Concursos P�blicos - ISP-Bi�')

@section('content')

    <div class="bg-gradient-to-r from-[#2563eb] to-[#2563eb] text-white py-16 scroll-reveal">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 class="text-5xl font-bold mb-4">Concursos P�blicos</h1>
            <p class="text-xl text-orange-100">Contrata��o de pessoal por meio de concurso p�blico</p>
        </div>
    </div>
    ...
    <div class="bg-white border-b scroll-reveal">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
            <div class="flex items-center text-sm text-gray-600">
                ...
                <span class="text-gray-900">Concursos P�blicos</span>
            </div>
        </div>
    </div>

    <!-- Informa��o sobre Concursos P�blicos -->
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-10">
            <div class="max-w-4xl mx-auto">
                <div class="flex items-start">
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-gray-900 mb-3">Contrata��o por Concurso P�blico</h3>
                        <p class="text-gray-700 leading-relaxed mb-3">
                            O <strong>Instituto Superior Polit�cnico do Bi� (ISP-Bi�)</strong>, sendo uma institui��o p�blica de ensino superior, 
                            contrata todo o seu pessoal exclusivamente atrav�s de <strong>concursos p�blicos</strong>, em conformidade com a 
                            legisla��o angolana e os princ�pios de transpar�ncia, igualdade de oportunidades e m�rito.
                        </p>
                        <p class="text-gray-700 leading-relaxed">
                            Todos os editais de concursos s�o publicados no Di�rio da Rep�blica e divulgados nos meios de comunica��o social, 
                            bem como nesta p�gina oficial. Os processos seguem crit�rios rigorosos de avalia��o para garantir a selec��o 
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 scroll-reveal">
        ...
        <section class="mb-12 scroll-reveal">
            ...
            <div class="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-xl transition-shadow interactive-card">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-2">T�cnicos</h3>
                    <p class="text-gray-600 text-sm">T�cnicos administrativos e de apoio</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-xl transition-shadow interactive-card">
                    ...
                    <p class="text-gray-600 text-sm">Bibliotec�rios, investigadores e outras fun��es</p>
                </div>
            </div>
        </section>
        ...
        <section class="mb-16 scroll-reveal">
            ...
            <div class="bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg p-12 text-center interactive-card">
                ...
                <p class="text-gray-600 mb-6">
                    N�o h� concursos p�blicos em andamento no momento. Cadastre-se para receber alertas quando novos concursos forem publicados.
                </p>
            ...
            <div class="space-y-4">
                ...
                <div class="bg-gray-50 p-6 rounded-lg interactive-card">
                    <div class="flex justify-between items-center">
                        <div>
                            <span class="inline-block bg-gray-300 text-gray-700 text-xs px-3 py-1 rounded-full mb-2">ENCERRADO</span>
                            <h3 class="text-lg font-semibold text-gray-700">Bibliotec�rio</h3>
                        </div>
                        <button class="text-teal-600 hover:text-teal-700">Ver Resultado</button>
                    </div>
                </div>
        ...
        <div class="bg-gradient-to-r from-[#2563eb] to-[#2563eb] rounded-xl p-8 text-white text-center scroll-reveal">
            <h2 class="text-3xl font-bold mb-4">Receber Alertas de Concursos P�blicos</h2>
            <p class="text-xl mb-8">Cadastre-se para receber notifica��es sobre novos concursos</p>
        ...
        <section class="mt-12 bg-white rounded-lg shadow-md p-8 scroll-reveal interactive-card">
            <h3 class="text-2xl font-bold text-gray-900 mb-6">Princ�pios dos Concursos P�blicos</h3>
            <div class="grid md:grid-cols-2 gap-6">
                <div class="flex items-start">
                    ...
                    <div>
                        <h4 class="font-bold text-gray-900 mb-2">Transpar�ncia</h4>
                        <p class="text-gray-600 text-sm">Todos os editais e resultados s�o publicados oficialmente e divulgados amplamente</p>
                    </div>
                </div>
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        <h4 class="font-bold text-gray-900 mb-2">M�rito</h4>
                        <p class="text-gray-600 text-sm">Selec��o baseada em crit�rios objectivos de compet�ncia e qualifica��o</p>
                    </div>
                </div>
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-sm">Conformidade com a legisla��o angolana e regulamentos internos</p>
                    </div>
                </div>
            </div>
        </section>
