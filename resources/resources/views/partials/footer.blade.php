  ...
  <div class="max-w-7xl mx-auto px-4 py-8 text-sm text-[var(--brand-dark)]">
    <div class="grid grid-cols-2 gap-4 md:flex md:flex-row md:justify-between md:items-center">
      <div class="bg-gray-50 rounded-lg p-4 flex items-center space-x-4">
        ...
        <div>
          <strong>Instituto Superior Politécnico do Bié</strong>
          <div class="text-xs text-gray-500">Endereço (placeholder)</div>
        </div>
      </div>
      <div class="bg-gray-50 rounded-lg p-4 text-gray-600 flex flex-col justify-center">
        <div><a href="/contactos" class="hover:underline link-brand">Contactos</a></div>
        <div class="mt-2">© ISP-Bié</div>
      </div>
    </div>
  </div>
</footer>
