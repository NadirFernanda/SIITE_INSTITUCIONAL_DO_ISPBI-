 ...
 * período, com base na nota de exame e nas vagas configuradas. Mesma lógica
 * de App\Http\Controllers\Admin\ResultadosController — esta funcionalidade é
 * exclusiva de Admin e Presidência, o DAAC não tem acesso a ela.
 */
class ResultadosController extends Controller
{
    public function index()
    {
        ...
        return view('presidencia.resultados.index', compact('linhas'));
    }
    ...
    public function calcular(Request $request, AdmissaoService $admissaoService)
    {
        ...
        return redirect()->route('presidencia.resultados.show', $dados)
    ...
    public function show(Request $request)
    {
        ...
        return view('presidencia.resultados.show', compact('curso', 'periodo', 'vagas', 'candidatos', 'resumoGrupos'));
    }
}
