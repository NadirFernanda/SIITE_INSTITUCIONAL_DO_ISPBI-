...
return [
    ...
    'missing_unless'       => 'O campo :attribute deve estar ausente excepto quando :other é :value.',
    ...
    'password'             => [
        ...
        'uncompromised' => 'O campo :attribute apareceu numa fuga de dados. Escolha um valor diferente.',
    ],
    'present'              => 'O campo :attribute deve estar presente.',
    'prohibited'           => 'O campo :attribute é proibido.',
    'prohibited_if'        => 'O campo :attribute é proibido quando :other é :value.',
    'prohibited_unless'    => 'O campo :attribute é proibido excepto quando :other está em :values.',
    ...
    'uploaded'             => 'O campo :attribute não foi enviado correctamente.',
    ...
    'attributes' => [
        ...
        'bi_emitido_em'          => 'local de emissão do BI',
        'bi_data_emissao'        => 'data de emissão do BI',
        'sexo'                   => 'sexo',
        'estado_civil'           => 'estado civil',
        'necessidade_especial'   => 'necessidade de educação especial',
        'residencia_municipio'   => 'município de residência',
        'residencia_bairro'      => 'rua/bairro de residência',
        'telefone'               => 'telefone',
        ...
        'instituicao_laboral'    => 'instituição laboral',
        'curso'                  => 'curso',
        'periodo'                => 'período',
